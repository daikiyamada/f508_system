...
<hr id="cp_hr04" />
<ul id="menu">
<li id="menu0"><a href="index.html"> メニュー</a></li>
<li id="menu1"><a href="calendar.html">F508予約システム</a></li>
...
<p id=news>受け取った名前 </p>
<p><?php echo "こんにちは".$_POST["name"]."さん"; ?></p>
<p><?php echo "あなたのパスワードは".$_POST["password"]."です。"; ?></p>

<div style="text-align: right;">最終更新日：2019年12月6日</div>
